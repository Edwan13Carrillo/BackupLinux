        ...
        Item {
            ...
            Item {
                ...
                Text {
                    ...
                    property var diasSemana: ["Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"]
                    text: diasSemana[new Date().getDay()] + " " + new Date().getDate()
                    color: "#ffffff"
                    font.family: "Okami"
                    font.bold: false
                    font.pointSize: 18
            ...
            initialItem: Login {
                ...
                actionItems: [
                    ActionButton {
                        ...
                        text: i18ndc("plasma_lookandfeel_org.kde.lookandfeel","Suspend to RAM","Suspender")
                    ...
                    ActionButton {
                        ...
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Reiniciar")
                    ...
                    ActionButton {
                        ...
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Apagar")
                    ...
                    ActionButton {
                        ...
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Otro Usuario")
            ...
            Login {
                ...
                userListModel: ListModel {
                    ...
                    Component.onCompleted: {
                        ...
                        setProperty(0, "name", i18nd("plasma_lookandfeel_org.kde.lookandfeel", "Escriba su nombre de usuario y contraseña"));
                ...
                actionItems: [
                    ...
                    ActionButton {
                        ...
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Usuarios")
